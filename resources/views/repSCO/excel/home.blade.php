...
<br>
        <table   >
          <tbody>
                   ...
                   <tr>
                       ...
                       <td colspan="8" align="center"style='font-weight:bold;'class="default"><font color="red">Del : {{$f1}}    Al : {{$f2}} </font> </td>
     ...
     <table  id="procesos" >
        ...
        <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th style='font-weight:bold;border:2px solid #f00;' align="center" colspan="2"  > REGISTRO</th>
        ...
        @foreach($procesos as $proceso)
            <tr >
                                    ...
                                    <td style='border:4px solid #f00;'>{{$proceso->tipo_emision}}</td>
                                    <td style='border:4px solid #f00;'>{{$proceso->estado_solicitud_digital}}</td>
                                    <td style='border:4px solid #f00;'>{{$proceso->fecha_revision}}</td>
                                    <td style='border:4px solid #f00;'> -- </td>
