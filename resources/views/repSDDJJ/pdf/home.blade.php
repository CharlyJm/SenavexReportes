...
<table class="table1">
   <tr>
      ...
      <tr>
          ...
          <td style="text-align:center; font-size: 15px;">A DECLARACIONES JURADAS</td>
...
<br>
   ...
   <table class="table1">
                            ...
                            <tr>
                                <td colspan="2"   align="center" class="table_texto1"> <font color="red">{{$f1}}  <br>  {{$f2}}  </font>    </td>
                      ...
                      @foreach($procesos as $proceso)
                           ...
                           <tr  class="table_texto4"> 
                                  <td class="table_texto4">{{$proceso->number_row}}</td>
                                   ...
                                   <td class="table_texto4">{{$proceso->emision}}</td>
